...
export default function Skills() {
    return (
        <section className="w-full mx-auto bg-gray-100 py-32 dark:bg-stone-900">
            <h2 className="text-2xl md:text-3xl text-left w-11/12 max-w-6xl mx-auto mb-4 font-semibold">
                Skills
            </h2>
