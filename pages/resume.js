export default function Resume() {
    return (
        <div className='w-11/12 max-w-5xl mx-auto mt-14'>
            <h2 className='text-4xl sm:text-6xl font-bold mb-12'>EXPERIENCE</h2>
            <div className='border-l-2 border-gray-900 pl-4 mb-16 dark:border-stone-700'>
            ...
            <div>
                <h2 className='text-4xl sm:text-6xl font-bold mb-12 mt-28'>EDUCATION</h2>
                <div className='border-l-2 border-gray-900 pl-4 mb-16 dark:border-stone-700'>
